...
If you give it a latitude,longitude it'll return which OS map the point resides in, along with some metadata about the map and an OS map reference for the point.
